    ...
    let(:user){create(:user, :admin)}
     ...
     describe "GET /new" do
       it "renders new" do
         ...
         expect(response.body).to include "Create Statements"
       end
     end
     ...
     describe "POST /create" do
       context "空欄なく入力した場合" do
         it "redirects to root path" do
           expect{
           post statements_path, params: {form_statement_collection:
            ...
            }.to change(Statement, :count).by (10)
     ...
     describe "DELETE /destroy" do
       ...
       it "redirects to index" do
         ...
         expect(response).to redirect_to statements_path
       end
     end
   end
