<template>
  <div class="text-center items-center justify-center">
    <h1 class="font-bold text-2xl text-white">回答集</h1>
    <div v-for="answer in answers" class="my-6 break-words h-28 bg-white list-none text-2xl border border-solid border-black rounded-lg" :key="answer">
